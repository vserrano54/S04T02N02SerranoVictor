package cat.itacademy.barcelonactiva.serrano.victor.s04.t02.n02.controllers;
...
import cat.itacademy.barcelonactiva.serrano.victor.s04.t02.n02.model.services.FrutaService;
...
public class FrutaController {
	...
	public ResponseEntity<?> update(@RequestBody Fruta frutaDetalle,@PathVariable(value="id") int id){
